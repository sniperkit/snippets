// https://stackoverflow.com/questions/20655702/signing-and-decoding-with-rsa-sha-in-go?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
...
func main() {
	...
	toSign := sha256sum("jerry.jacobs@xor-gate.org")
	fmt.Println("hashed", toSign)
